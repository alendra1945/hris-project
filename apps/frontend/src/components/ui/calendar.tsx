  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn('absolute bg-white inset-0 opacity-0 dark:bg-slate-950', defaultClassNames.dropdown),
        caption_label: cn(
        ...
        week_number: cn('text-[0.8rem] select-none text-slate-500 dark:text-slate-400', defaultClassNames.week_number),
        day: cn(
          'relative w-full h-full p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md group/day aspect-square select-none',
          defaultClassNames.day
        ),
        range_start: cn('rounded-l-md bg-slate-100 dark:bg-slate-800', defaultClassNames.range_start),
        ...
        disabled: cn('text-slate-500 opacity-50 dark:text-slate-400', defaultClassNames.disabled),
